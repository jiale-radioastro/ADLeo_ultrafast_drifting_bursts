...
fig=plt.figure(figsize=(7.25,5),dpi=400)
...
ax01=fig.add_axes([0.2,0.57,0.16,0.01])

npz_name='bmap'+'_r'+str(1.05)+'_nospot'+'.npz'
npz_data=np.load(file_dir+npz_name)
lon0=npz_data['lon0']
colat0=npz_data['colat0']
br0=npz_data['br0']
babs1=npz_data['babs1']
lb1=npz_data['lb1']
npz_name='bmap'+'_r'+str(1.1)+'_nospot'+'.npz'
npz_data=np.load(file_dir+npz_name)
babs2=npz_data['babs1']
lb2=npz_data['lb1']
sz=np.shape(lon0)

a0 = ax0.pcolor(lon0[:,:], colat0[:,:], br0[:,:]/1e3,cmap=cmap1,norm=norm1,rasterized=True)
...
ax0.text(-0.2,-0.15,'ZDI map', rotation='vertical',fontsize=9,weight='bold',transform=ax0.transAxes)
ax0.text(-0.13,0.95,'A',fontsize=9,weight='bold',transform=ax0.transAxes)
ax0.grid(False)
...
ax1.text(-0.13,0.95,'B',fontsize=9,weight='bold',transform=ax1.transAxes)
ax1.grid(False)
...
ax2.text(-0.13,0.95,'C',fontsize=9,weight='bold',transform=ax2.transAxes)
ax2.grid(False)
...
ax3.text(-0.3,0.95,'D',fontsize=9,weight='bold',transform=ax3.transAxes)
...
ax4.text(-0.3,0.95,'E',fontsize=9,weight='bold',transform=ax4.transAxes)
...
babs1=npz_data['babs1']
lb1=npz_data['lb1']
npz_name='bmap'+'_r'+str(1.1)+'_rho'+str(rho)+'_bmax'+str(bmax)+'.npz'
npz_data=np.load(file_dir+npz_name)
babs2=npz_data['babs1']
lb2=npz_data['lb1']
sz=np.shape(lon0)

a5 = ax5.pcolor(lon0[:,:], colat0[:,:], br0[:,:]/1e3,cmap=cmap1,norm=norm1,rasterized=True)
...
ax5.text(-0.2,-0.35,'ZDI map + starspots', rotation='vertical',fontsize=9,weight='bold',transform=ax5.transAxes)
ax5.grid(False)
ax5.text(-0.13,0.95,'F',fontsize=9,weight='bold',transform=ax5.transAxes)

ax51.spines['left'].set_linewidth=0.28
ax51.spines['right'].set_linewidth=0.28
ax51.spines['bottom'].set_linewidth=0.28
ax51.spines['top'].set_linewidth=0.28
ax51.pcolor(lon0[:,:], colat0[:,:], br0[:,:]/1e3,cmap=cmap1,norm=norm1,rasterized=True)
...
a6 = ax6.pcolor(lon0[:,:], colat0[:,:], lb1[:,:],cmap=cmap2,norm=norm2,rasterized=True)
...
ax6.contour(lon0[:,:], colat0[:,:], babs1[:,:],levels=[1000/2.8,1500/2.8],colors='black')
ax6.contour(lon0[:,:], colat0[:,:], babs1[:,:],levels=[1000/2.8/2,1500/2.8/2],colors='darkgreen')
...
ax6.grid(False)
ax6.text(-0.13,0.95,'G',fontsize=9,weight='bold',transform=ax6.transAxes)

ax61.spines['left'].set_linewidth=0.28
ax61.spines['right'].set_linewidth=0.28
ax61.spines['bottom'].set_linewidth=0.28
ax61.spines['top'].set_linewidth=0.28
ax61.pcolor(lon0[:,:], colat0[:,:], lb1[:,:],cmap=cmap2,norm=norm2,rasterized=True)
ax61.plot([30/180*np.pi,-30/180*np.pi],[np.pi*(80/180),np.pi*(80/180)],'--',color='grey',linewidth=1)
ax61.contour(lon0[:,:], colat0[:,:], babs1[:,:],levels=[1000/2.8,1500/2.8],colors='black')
ax61.contour(lon0[:,:], colat0[:,:], babs1[:,:],levels=[1000/2.8/2,1500/2.8/2],colors='darkgreen')
ax61.set_xlim([30/180*np.pi,-30/180*np.pi])
ax61.set_ylim(95/180*np.pi,65/180*np.pi)
ax61.set_xticks([])
ax61.set_yticks([])

a7 = ax7.pcolor(lon0[:,:], colat0[:,:], lb2[:,:],cmap=cmap2,norm=norm2,rasterized=True)
...
ax7.contour(lon0[:,:], colat0[:,:], babs2[:,:],levels=[1000/2.8,1500/2.8],colors='black')
ax7.contour(lon0[:,:], colat0[:,:], babs2[:,:],levels=[1000/2.8/2,1500/2.8/2],colors='darkgreen')
...
ax7.grid(False)
ax7.text(-0.13,0.95,'H',fontsize=9,weight='bold',transform=ax7.transAxes)

ax71.spines['left'].set_linewidth=0.28
ax71.spines['right'].set_linewidth=0.28
ax71.spines['bottom'].set_linewidth=0.28
ax71.spines['top'].set_linewidth=0.28
ax71.pcolor(lon0[:,:], colat0[:,:], lb2[:,:],cmap=cmap2,norm=norm2,rasterized=True)
ax71.plot([30/180*np.pi,-30/180*np.pi],[np.pi*(80/180),np.pi*(80/180)],'--',color='grey',linewidth=1)
ax71.contour(lon0[:,:], colat0[:,:], babs2[:,:],levels=[1000/2.8,1500/2.8],colors='black')
ax71.contour(lon0[:,:], colat0[:,:], babs2[:,:],levels=[1000/2.8/2,1500/2.8/2],colors='darkgreen')
...
index=find_neartime(colat0[0,:],np.pi/180*120)
lb3list=lb1[:,index:].flatten()
babs3list=babs1[:,index:].flatten()
...
ax8.text(-0.3,0.95,'I',fontsize=9,weight='bold',transform=ax8.transAxes)
...
index=find_neartime(colat0[0,:],np.pi/180*120)
lb4list=lb2[:,index:].flatten()
babs4list=babs2[:,index:].flatten()
...
ax9.text(-0.3,0.95,'J',fontsize=9,weight='bold',transform=ax9.transAxes)
